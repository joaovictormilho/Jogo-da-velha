...
public class JogoDaVelhaJava extends JFrame{
	
	ImageIcon iconCirculo = new ImageIcon(getClass().getResource("arq/circulo.png"));
	ImageIcon iconX = new ImageIcon(getClass().getResource("arq/x.png"));
	...
	public boolean testarVitoria(int jog) {
		...
		return blocos[2].quem==jog && blocos[4].quem==jog && blocos[6].quem==jog;
	}
